...
<Image
	alt={`Abortion protesters in front of the Supreme Court.`}
	src={`/images/anvil/2022-23/issue1/abortion-protests.jpeg`}
    width={1500}
    height={1000}
    caption={`Abortion protesters in front of the Supreme Court.`}
/>
